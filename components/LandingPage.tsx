...
const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-inter text-gray-900">
      ...
      <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-10">
              <a href="#features" className="text-[10px] font-black text-gray-400 hover:text-primary-600 transition-colors uppercase tracking-[0.2em]">Features</a>
              <a href="#how-it-works" className="text-[10px] font-black text-gray-400 hover:text-primary-600 transition-colors uppercase tracking-[0.2em]">Framework</a>
              <button 
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 p-8 space-y-6">
             <a href="#features" className="block text-xs font-black uppercase tracking-widest text-gray-400" onClick={() => setIsMenuOpen(false)}>Features</a>
             <a href="#how-it-works" className="block text-xs font-black uppercase tracking-widest text-gray-400" onClick={() => setIsMenuOpen(false)}>Framework</a>
             <button 
                onClick={onLoginClick}
      ...
      {/* Hero Section */}
      <section className="relative pt-40 pb-20 lg:pt-52 lg:pb-32 overflow-hidden bg-slate-50/50">
